...
<head>
    ...
    <title>Sublime</title>
    <link rel="StyleSheet" href="../Style/Sushi.css" type="text/css">
</head>
<header>
    ...
    <body>
        <form action="update.php" method="POST">
            ...
            <input type="file"  name="imagen" placeholder="imagen" accept="image/png, image/jpeg" value="<?php echo $row['imagen']  ?>">
